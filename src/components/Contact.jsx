      ...
      >
        ...
        <div className="contact__data">
          <div className="contact__data__description">
            ...
            <p>
              If you have any questions regarding security please read the documentation.
            </p>
            <div>
              <p>
                <strong>Email:</strong> shivamghodke@gmail.com
              </p>
              <p>
                <strong>Website:</strong> www.lockshield.com
              </p>
            </div>
          </div>
